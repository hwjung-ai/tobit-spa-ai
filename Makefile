...
api-dev:
	cd apps/api && DEFER_HEAVY_STARTUP=true ENABLE_AUTO_MIGRATE=false ENABLE_RESOURCE_WATCHER=false .venv/bin/python -m uvicorn main:app --reload --port 8000 --timeout-graceful-shutdown 2
