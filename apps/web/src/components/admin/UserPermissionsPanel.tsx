...
const UserPermissionsPanel: React.FC<UserPermissionsPanelProps> = ({ userId }) => {
  ...
  if (!userId) {
    return (
      <div className="bg-surface-base dark:bg-surface-base rounded-lg border dark:border-variant p-8 text-center">
        <p className="">Select a user to manage permissions</p>
      </div>
    );
  }
  ...
  if (loading) {
    return (
      <div className="bg-surface-base dark:bg-surface-base rounded-lg border dark:border-variant p-8">
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Tabs */}
      <div className="flex border-b dark:border-variant bg-surface-base dark:bg-surface-base rounded-t-lg">
        <button
        ...
        <div className="space-y-6">
          ...
          <div className="bg-surface-base dark:bg-surface-base rounded-lg border dark:border-variant p-6">
            ...
            {permissions.length === 0 ? (
              <p className=" text-center py-8">No permissions granted</p>
            ) : (
      ...
      {/* Audit Log Tab */}
      {activeTab === 'audit' && (
        <div className="bg-surface-base dark:bg-surface-base rounded-lg border dark:border-variant overflow-hidden">
                ...
                {auditLogs.length === 0 ? (
                  ...
                  auditLogs.map((log, index) => (
                    <tr key={index} className="hover:">
                      ...
                      <td className="px-6 py-3 text-sm ">{log.permission.replace(/_/g, ' ')}</td>
                      <td className="px-6 py-3 text-sm ">{log.admin_id}</td>
                      <td className="px-6 py-3 text-sm ">{log.reason || '-'}</td>
                      <td className="px-6 py-3 text-sm ">
