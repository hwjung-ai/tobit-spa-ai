        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl max-w-md w-full mx-4">
                <div className="p-6 border-b border-slate-800">
                    <h2 className="text-xl font-bold text-slate-100 mb-1">Create Schema Asset</h2>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="e.g., factory_database"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <p className="mt-2 text-xs text-slate-500">
                            💡 Source must be published before creating schema
                        </p>
                    </div>
