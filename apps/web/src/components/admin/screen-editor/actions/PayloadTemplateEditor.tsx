    ...
    return (
      <div ref={ref} className={`space-y-3 ${className}`}>
        ...
        <div className="space-y-2 max-h-60 overflow-y-auto border border-gray-200 rounded p-3 bg-gray-50">
          {fields.length === 0 ? (
            ...
            fields.map((field, index) => (
              <div key={index} className="space-y-1 p-2 bg-white border border-gray-200 rounded">
                {/* Key input */}
                <div>
        ...
        <details className="text-xs">
          <summary className="cursor-pointer text-gray-600 hover:text-gray-700 font-medium">
            View as JSON
          </summary>
