    ...
    <div className="space-y-6">
      <div className="sm:flex sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-2 text-sm  dark:" style={{ color: "var(--muted-foreground)" ,  color: "var(--muted-foreground)" }}>
            Manage database catalogs and configure schema discovery
          </p>
        </div>
      </div>

      <Suspense fallback={<div className="text-center py-8  dark:" style={{ color: "var(--muted-foreground)" ,  color: "var(--muted-foreground)" }}>Loading catalogs...</div>}>
        <CatalogsContent />
      </Suspense>
    </div>
  );
