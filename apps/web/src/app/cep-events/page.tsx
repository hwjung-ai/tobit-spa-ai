  ...
  return (
    <div className="space-y-6 builder-shell builder-text">
      <header className="flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-3 rounded-2xl border  dark: bg-[var(--background)] dark: px-4 py-3 text-xs uppercase tracking-wider " style={{borderColor: "var(--border)", color: "var(--muted-foreground)", backgroundColor: "var(--surface-overlay)"}}>
      ...
      {runLoading ? (
        <section className="rounded-2xl border  dark: /70 px-5 py-4" style={{borderColor: "var(--border)", backgroundColor: "var(--surface-base)"}}>
          <p className="text-sm " style={{color: "var(--muted-foreground)"}}>Loading CEP run details …</p>
        </section>
      ) : runDetail ? (
        <section className="rounded-2xl border  dark: /70 px-5 py-4 space-y-3" style={{borderColor: "var(--border)", backgroundColor: "var(--surface-base)"}}>
          {runError ? (
          ...
          {runDetail.found ? (
            <>
              <div className="grid grid-cols-2 gap-4 text-sm  dark:" style={{color: "var(--foreground-secondary)"}}>
                <div>
              ...
              <div>
                ...
                <div className="mt-2 overflow-x-auto">
                  <table className="min-w-full text-left text-xs  dark:" style={{color: "var(--foreground-secondary)"}}>
                    <thead>
                      <tr>
                        {["endpoint", "method", "value_path", "op", "threshold", "extracted_value", "evaluated", "status", "error"].map(
                          (column) => (
                            <th
                              key={column}
                              className="border-b  dark: px-2 py-1 font-semibold uppercase tracking-[0.3em] " style={{borderColor: "var(--border)", color: "var(--muted-foreground)"}}
                            >
                              {column}
                            </th>
                          )
              ...
              {runDetail.raw ? (
                <details className="rounded-2xl border  dark:  p-3 text-xs " style={{borderColor: "var(--border)", color: "var(--muted-foreground)", backgroundColor: "var(--surface-overlay)"}}>
      ...
      >
        <section className="rounded-2xl border  dark: bg-[var(--background)] dark: p-4" style={{borderColor: "var(--border)", backgroundColor: "var(--surface-overlay)"}}>
          <div className="mb-4 flex flex-wrap items-center gap-3">
            <select
              value={ackedFilter}
              onChange={(event) => setAckedFilter(event.target.value as typeof ackedFilter)}
              className="rounded-xl border  dark: /70 px-3 py-2 text-[11px]  dark: tracking-normal" style={{borderColor: "var(--border)", color: "var(--foreground-secondary)", backgroundColor: "var(--surface-base)"}}
            >
            ...
            <button
              ...
              className="rounded-xl border  dark: /80 px-3 py-2 text-[11px]  dark: transition hover: tracking-normal" style={{borderColor: "var(--border)", color: "var(--foreground-secondary)", backgroundColor: "var(--surface-base)"}}
            >
              Refresh
            </button>
            <button
          ...
          <div className="ag-theme-cep h-[540px] w-full rounded-2xl border  dark: /70" style={{borderColor: "var(--border)", backgroundColor: "var(--surface-base)"}}>
        ...
        <aside className="space-y-4 rounded-2xl border  dark: bg-[var(--background)] dark: p-4 overflow-y-auto custom-scrollbar max-h-[610px]" style={{borderColor: "var(--border)", backgroundColor: "var(--surface-overlay)"}}>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs uppercase tracking-wider " style={{color: "var(--muted-foreground)"}}>Event detail</p>
              <h3 className="text-lg font-semibold dark:" style={{color: "var(--foreground)"}}>
            ...
            {selectedEvent ? (
              <button
                ...
                className="rounded-2xl border dark: bg-emerald-500/80 px-3 py-2 text-[11px] font-semibold uppercase tracking-wider dark: transition hover:bg-emerald-400 disabled:" style={{color: "var(--foreground)", borderColor: "var(--border)", backgroundColor: "var(--surface-elevated)"}}
              >
          ...
          {selectedEvent ? (
            <div className="space-y-3 text-sm  dark:" style={{color: "var(--foreground-secondary)"}}>
              <div className="rounded-2xl border  dark: bg-[var(--background)] dark: p-3" style={{borderColor: "var(--border)", backgroundColor: "var(--surface-overlay)"}}>
                <p className="text-xs uppercase tracking-wider " style={{color: "var(--muted-foreground)"}}>Summary</p>
                <p className="mt-2 text-sm  dark:" style={{color: "var(--foreground-secondary)"}}>{selectedEvent.summary}</p>
              </div>
              <div className="grid gap-2 rounded-2xl border  dark: bg-[var(--background)] dark: p-3 text-xs  dark:" style={{borderColor: "var(--border)", color: "var(--foreground-secondary)", backgroundColor: "var(--surface-overlay)"}}>
              ...
              <div className="rounded-2xl border  dark: bg-[var(--background)] dark: p-3" style={{borderColor: "var(--border)", backgroundColor: "var(--surface-overlay)"}}>
                ...
                <pre className="mt-2 max-h-72 overflow-auto text-xs  dark: custom-scrollbar" style={{color: "var(--foreground-secondary)"}}>
              ...
              {selectedEvent.exec_log ? (
                <div className="rounded-2xl border  dark: bg-[var(--background)] dark: p-3" style={{borderColor: "var(--border)", backgroundColor: "var(--surface-overlay)"}}>
                  ...
                  <pre className="mt-2 max-h-64 overflow-auto text-xs  dark: custom-scrollbar" style={{color: "var(--foreground-secondary)"}}>
