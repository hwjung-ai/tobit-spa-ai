...
ROLE_PERMISSION_DEFAULTS = {
    ...
    RolePermissionDefault.MANAGER: [
        ...
        ResourcePermission.SCREEN_CREATE,
        ResourcePermission.SCREEN_EDIT,
        ResourcePermission.SCREEN_PUBLISH,
        ResourcePermission.SCREEN_ROLLBACK,
        ResourcePermission.SCREEN_DELETE,
