...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("exec_step_id", postgresql.UUID(as_uuid=True), primary_key=True, nullable=False),
        sa.Column("exec_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("tb_api_exec_log.exec_id"), nullable=False),
